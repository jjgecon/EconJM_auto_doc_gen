...
_\* I noticed a shift that most non-US positions do not require Research or Teaching Statements. But these will come up in the interviews, so there is value in writting them._
...
Start early and be organized, specially if you are also targeting 250+ applications.
@app_timeline shows the number of applications I sent each day (right axis) and the cummulative timeline of my applications (left axis).
...
_What if you don't hear anything after mid-December?_
...
#figure(caption: "Weekly Status")[
  ...
  #fig_notes(width: 90%)[
    The count displayed in the $y$-axis is truncated for better visibility of the interviews, fly-outs, and offers I received. The total number of applications is 250+.
    ]
] <week_status>
...
Practice this version until you can adjust on the fly, because interviewers will often interrupt with questions.
#footnote[In my experience, they waited until the last concluding paragraph to interrupt me (think around the 3-minute mark)]
Answer briefly, then steer them back to the main points you still want to make. Above all, sound genuinely excited about your research and about joining the department or postdoc project.

Remember that the search committee is looking for a colleague.
That means that you should avoid showing yourself as a student, and instead as an independent reseracher.
One of the mistakes I did in one interview happened when answering a question about where do I plan to publish my JMP. 
I answered:
...
Concrete evidence of what you have already done is a far stronger signal than what you plan to do. 
In other words, you are allowed to *brag* about your relevant accomplishments.
Mention your published papers and working papers before discussing your research agenda.
If you are already working on an idea, describe it and talk about next step.
You might also want to mention work in progress from prominent faculty you are collaborating with.
...
When they ask if you have any questions, say that you don't have any questions right now.
But, you will reach out if any question comes up and comment on your excitement for the position. #footnote[Recommended by #link("https://spot.colorado.edu/~antmanf/")[Francisca Antman] and #link("https://david-schindler.de/")[David Schindler].]
Some of my attempts to show that I did my research before the position:

#quote()[The videos introducing the department to undergraduate has good production value ...

The research agenda of the postdoc is exciting because of ...

I saw that the university is building a new building which suggests ...]
...
#quote()[What does a Associate (Generalist) mean?

How much autonomy will I have to take cases?

Are there cases of new hires who failed to build up a reputation?]

Send a short thank you email a day after the interview to the people who interviewed you.
Try to make them a bit more personal by mentioning something specific from the interview.
If you made a mistake in the interview, you can use this opportunity to correct it or clarify an answer you were not happy with.
...
They will know the best strategy to move forward.
They might be willing to help you giving mock interviews or give you some advice on how to answer specific questions.
They can also help you to manage your nerves during this stressful time.

You will only hear back from those institutions that will invite you to a fly-out, at least according to #link("https://www.aeaweb.org/content/file?id=869")[John Cawley's guide].
They should typically let you know within 1-2 weeks after the interview.
Some institutions might not let you know, so ask your advisor when it's the appropiate time to reach out for an update.
In my case, I had to reach out to one institutions for an update after 3-4 weeks of no updates.
#footnote[There was the holiday break in between, so I waited until mid January to reach out.]
Where they commented that I was _waitlisted_ for a fly-out, which can either be true, or just a nice way to say that I was not invited to a fly-out.
...
Although the lunch and dinner are informal settings, you should still treat them as part of the fly-out and be on your best behavior.
At the end of the day, they are searching for colleagues, so you want to show that you can fit in the department culture.

In my experience, the whole day is tirering, with meetings back to back and little time to rest and go to the bathroom.
In the interviews I expected to receive technical questions about my work, but in most it was along the lines of "_You are doing cool research, here what I'm doing ..._"
And in some cases, the interviews are about _selling_ the department to you.
You will meet with some senior professors which you can learn more about the institutional details (e.g. teaching load, research support, tenure track requirements, service, etc).
I tried to squeeze personal questions (e.g. where does faculty usually live, how is the city, etc) in these meetings when the conversation died down.
My seminar was planned during lunch time, and the next couple of interviews where mostly about my JMP with more technical discussions.
I also had an _odd_ interview, where a professor asked me about a sleeping project quite unrelated to research agenda.
So you have to be prepared to talk about any project that you put on your CV or website.
After 6pm, I had dinner with 2 faculty members that have a similar situation to mine, "young" married with a baby or toddler.
...
No common structure here and will depends on the projects/team.

Example 1: present my JMP in 1 hour to the team (4 people).

Example 2: no fly-out and skipped to the offer stage.
...
My M.A. advisor told me (in the context of Ph.D. applications) the following: 

#quote(attribution: [#link("https://sites.google.com/site/franciscoparro1")[Francisco Parro]])[All you need to have is one offer. When you get one, you know for sure that you will have a [job] next [academic] year.]
