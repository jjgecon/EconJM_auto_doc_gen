...
= The Hidden Curriculum of the Academic Job Market
_by Javier Gonzalez_

INTRO on why even with resoruces there are a lot of hidden curriculum aspects of the job market that are not well explained in the resources available online. Or are not designed for low-ranked schools.

Take this with a grain of salt, as this is my personal experience on the job market in the 2025-26 cycle.
...
#quote[My future research will be dedicated to expanding this methodological pipeline ...]

== My performance on the Market in 2025-26

=== Aplications

- general descriptive statistics of the applications you sent
  - Number of applications sent
  - Types of positions (assistant prof, postdoc, industry)
...
- General descriptives of my results
- show a timeline of the interviews and fly-outs

=== Why do I think I got several interviews?
...
=== Common set ups depending on the type of job
...
- Although the advice is to have a 1min, 5min, and a 10m spiel of your JMP (onion idea) I have found that a good 3-4min version works better for most interviews
...
- Practice your interview skills
  ...
  - practice with peers that are also on the market
...
- When they ask if you have any questions it has been recommended to (#link("https://spot.colorado.edu/~antmanf/")[Francisca Antman] and #link("https://david-schindler.de/")[David Schindler])
  - Say that you don't have any, but if you do that you will reach out and comment on your exciment for the position
...
- send a thank you email a couple hours or a day after the interview
  - keep it short and sweet
  - if you made a mistake in the interview, you can use this opportunity to correct it
...
- For the question Why our department/project/firm?
  - Personal reasons > Profesional reasons
    ...
    - These are some of the examples I used:
      - I have family in the area (only if it true, if it's a family member you never talk to maybe don't mention it)
      - Co-authors or others in your network are in the area
      - The department has a strong culture in `YOUR_FIELD`

== Fly-outs

- Do not have your prefered place first
