...
My goal as an educator is to make the powerful framework of economics accessible and applicable for every student, aligning with Williams College's commitment to fostering intellectual curiosity and an inclusive learning environment.
...
This approach makes the material more accessible to students from diverse backgrounds and aligns with Williams' dedication to serving a broadly diverse student population.
...
Student feedback highlights an encouraging atmosphere where inquiry thrives, mirroring Williams’ values of close faculty-student mentorship and inclusivity. Beyond classroom teaching, I am committed to contributing to the department’s vibrant culture of research and collaboration, particularly in applied microeconomics and related interdisciplinary areas such as development and policy economics. This dedication aligns with the Economics Department’s strong emphasis on both teaching excellence and active scholarship.