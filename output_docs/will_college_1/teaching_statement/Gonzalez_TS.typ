...
For example, while tutoring student-athletes at SMU, I learned to explain concepts like elasticity not just with formulas, but as a measure of “sensitivity” to price changes.
This approach helps students from all backgrounds grasp core concepts and build a strong foundation.

Second, I believe learning happens through active engagement.
...
Their excitement in mastering a subject they found intimidating was a powerful affirmation of my philosophy: when complex ideas are made clear and students actively practice, anyone can excel.
Ultimately, my teaching is driven by the goal of empowering students, transforming economics into a practical toolkit that equips them with a lasting ability to analyze the world around them.